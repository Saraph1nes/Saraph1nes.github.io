...
这是整个设计中最精妙的部分，通过**两个 Promise 的链式传递**实现异步结果返回。
...
1. **利用底层机制**：`__wxExparserNodeId__` 自动生成页面唯一标识
...
- [Exparser 框架原理](https://developers.weixin.qq.com/community/develop/article/doc/000c4e433707c072c1793e56f5c813)
